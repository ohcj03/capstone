...
ㄴ시간이 좀 지난 뒤 메인 화면으로 나가면 다시 로그인하라고 뜨는 상태

창을 종료하기 전까지 쭉 로그인을 유지하는 상태로 전환해야 함



09/29
리뷰를 메인화면으로 옯기고 예약하기 페이지 따로 제작하거나 리뷰하기 이름을 예약하기로 바꾼 후 리뷰하는 리스트 옆에 추천 파트너가 뜨도록 하기?

사용자 입장에서 파트너를 찾고 예약하기 너무 번거로움

파트너 자세히 보기 창에서 밑에 다른 후기들 실제로 그 파트너의 관한 후기들만 가져오도록 지정해야 함
